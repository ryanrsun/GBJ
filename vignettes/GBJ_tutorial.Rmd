...
> "The Generalized Berk-Jones Statistic for Genetic Association Tests, Ryan Sun and Xihong Lin, *Submitted*"
...
Now we have both the test statistics and their correlation matrix, we can apply GBJ. If you are not convinced that GBJ is the correct test for your application, you can also apply GHC, HC, BJ, or minP as demonstrated below: 
...
```{r}
# Load the genotype data at FGFR2 SNPs for 91 Great Britain (GBR) subjects from the 1000 Genomes Project
