...
> "The Generalized Berk-Jones Statistic for Set-Based Inference in Genetic Association Studies, Ryan Sun and Xihong Lin, *Submitted*"
...
* A worked example in the context of Genome-Wide Association Studies (GWAS) where only GWAS summary statistics are available. 
